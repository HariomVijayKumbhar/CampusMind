...
export default function Chat() {
  ...
  return (
    <ProtectedRoute>
      ...
      <div className="flex h-screen flex-col" style={{ background: 'rgb(15,15,23)' }}>
        {/* Minimal header */}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 5.25a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75zm0 5.25a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />
              </svg>
            </button>
            <Link href="/chat" className="flex items-center gap-2 group">
              ...
              <span className="text-sm font-semibold text-white">CampusMind</span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold text-white transition-all hover:ring-2 hover:ring-violet-500/50"
              ...
              {menuOpen && (
                <div
                  className="absolute right-0 top-10 z-50 w-52 rounded-xl border border-white/10 p-1.5 shadow-2xl animate-slide-up"
